...
//                                Label("App.community", systemImage: "at").tag(AppSection.community)
            ...
            .onAppear {
                ...
                if AppVersion.appHadUpdated(ignoreBuildNumber: false) ?? false && UserDefaults.standard.integer(forKey: "LastSeenWhatsNewHash") != stableHashOfWhatsNew() || forceDisplayWhatsNewSheet {
...
enum ToolTab: Hashable {
    case home, eventTracker, chartSimulator, storyViewer, live2dViewer, assetExplorer, station, zeileEditor
}
